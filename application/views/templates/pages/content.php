<div class="content"> 
    <div class="breadLine">
        <ul class="breadcrumb">
            ...
            <li class="active"><?php echo __('CMS') ?></li>
        </ul>
    </div>
                        ...
                        <tbody>
                            ...
                            foreach($pages as $v)
                            {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success" href="<?php echo Kohana::$config->load('globals.base_url') ?>pages/new/<?php echo $v -> id; ?>"><?php echo __('Edit') ?></a>                                        
                                    </td>
                                    <td>
