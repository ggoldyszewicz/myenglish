<div class="content"> 
    <div class="breadLine">
        <ul class="breadcrumb">
            ...
            <li><?php echo __('Adverts') ?> <span class="divider">></span></li>
            <li class="active"><?php echo __('Delete advert') ?></li>
        </ul>
    </div>
        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                <div class="head">
                    ...
                    <h1><?php echo __('Delete advert') ?></h1>
                    <div class="clear"></div>
                </div>
                <div class="block-fluid">                        
                    <?php
                    echo Form::open('adverts/delete', array('method' => 'post', 'enctype' => 'multipart/form-data', 'id' => 'adverts_delete'));
                    $selected_advert = isset($advert_id) ? $advert_id : 0;
                    echo Form::hidden('advert_id', $selected_advert);
                    ?>
                    <div class="row-form">
                        <div class="span3"></div>
