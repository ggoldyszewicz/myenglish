                ...
                <div class="block-fluid">                        
                    ...
                    <div class="row-form row-form-content">
                        ...
                        <?php 
                            ...
                            echo __('Word / sentence (en)').'*:<br>';
                            echo __('Translation (pl)').'*:'; 
                        ?>
                        </div>
                        <div class="span9">
                            <?php 
                            echo Form::input('word[]', $selected_name, array('class' => 'required word')).'<br>';
                            echo Form::input('translation[]', $selected_surname, array('class' => 'required translation'));
                            ?>
                        </div>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div class="row-form">
                        <div class="span3"></div>
                        <div class="span9"><a style="height: 18px; padding-top: 1px; float: right;" class="btn btn-success" href="<?php echo Kohana::$config->load('globals.base_url') ?>category/index/<?php echo $category_id ?>"><?php echo __('Cancel') ?></a> <?php echo Form::submit(NULL, __('Save'), array('class' => 'btn')); ?></div>
                        <div class="clear"></div>
                    </div>                         
                    <?php
                    echo Form::close();
...
{   
    ...
    $('body').keyup(function(e) {
        ...
        if (code == '9' && $('.add_another').last().is(':focus')) {
            add();
        }
     });
