        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                <div class="head">
                    ...
                    <h1><?php echo __('Add brand') ?></h1>
                    <div class="clear"></div>
                </div>
                <div class="block-fluid">                        
                    <?php
                    echo Form::open('brands/new', array('method' => 'post', 'enctype' => 'multipart/form-data', 'id' => 'brands_new'));
                    ...
                    <div class="row-form">
                        <div class="span3"></div>
                        <div class="span9"><a style="height: 18px; padding-top: 1px;" class="btn btn-success" href="<?php echo Kohana::$config->load('globals.base_url') ?>brands"><?php echo __('Cancel') ?></a> <?php echo Form::submit(NULL, __('Save'), array('class' => 'btn')); ?></div>
                        <div class="clear"></div>
                    </div>                         
                    <?php
                    echo Form::close();
