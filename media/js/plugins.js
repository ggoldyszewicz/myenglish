$(document).ready(function(){
   ...
   // TOOLTIPSborder:{
        ...
        // WYSIWIG HTML EDITOR
         ...
         {
            $("#tSortable_2").dataTable({"iDisplayLength": 50, "sPaginationType": "full_numbers","bLengthChange": false,"bFilter": true,"bInfo": false,"bPaginate": true, "aoColumns": [ { "bSortable": false }, null, null, null]});
         }
         
         if($("#tSortable_4").length > 0)
         {
            $("#tSortable_4").dataTable({"iDisplayLength": 50, "sPaginationType": "full_numbers","bLengthChange": false,"bFilter": true,"bInfo": false,"bPaginate": true, "aoColumns": [ { "bSortable": false }, null, null, null, null, null]});
         }
});
